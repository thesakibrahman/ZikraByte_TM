  ...
  return (
    ...
    <>
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className="p-5 border-b border-green-100 lg:block hidden">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-fuchsia-500 to-green-600 flex items-center justify-center text-white font-bold shadow-md">
              {initial}
            </div>
            <div>
              ...
              <p className="text-sm text-green-500 font-medium flex items-center gap-1">
                <Sparkles className="w-3 h-3" /> Let's Start New
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-auto pt-6 lg:block hidden">
            <div className={TIP_CARD.container}>
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className={TIP_CARD.title}>Zikrabyte</h3>
                  <p className={TIP_CARD.text}>
                    Project Managerment Tools Developed by Sakib
